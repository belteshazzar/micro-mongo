(function(global, factory) {
  ...
  class WorkerBridge extends eventsExports.EventEmitter {
    ...
    static async create(options = {}) {
      ...
      if (!workerPath) {
        const buildUrl = new URL("../build/server-worker.js", typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("micro-mongo-2.0.0.umd.js", document.baseURI).href);
  ...
  class BrowserWorkerBridge extends WorkerBridge {
    constructor(options = {}) {
      ...
      const workerUrl = options.workerUrl || new URL("../build/server-worker.js", typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("micro-mongo-2.0.0.umd.js", document.baseURI).href);
...
//# sourceMappingURL=micro-mongo-2.0.0.umd.js.map
